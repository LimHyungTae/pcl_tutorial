...
export const ko: LocaleDict = {
  ...
  source: {
    label: "입력",
    presets: {
      bunny:     { name: "Stanford Bunny", scene: "CAD",  hint: "메시 꼭짓점 · 약 1.9k pt" },
      naverlabs: { name: "NaverLabs",      scene: "실내", hint: "VLP-16 LiDAR · 약 2.9만 pt" },
      kitti:     { name: "KITTI",          scene: "실외", hint: "HDL-64 LiDAR · 약 12만 pt" },
    },
    custom: "직접 업로드",
  ...
  chapters: {
    lec03: { title: "Transformation", subtitle: "4×4 강체 변환 — 평행이동과 회전을 슬라이더로 직접 적용." },
    ...
    lec11: { title: "Iterative Closest Point", subtitle: "Step / Play로 매 iteration의 짝 찾기 → pose update를 직접 관찰." },
