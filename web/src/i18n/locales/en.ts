export const en = {
  ...
  lec11: {
    ...
    statusOk: "Converged · fitness {fitness} · {pairs} pairs",
    statusWarn: "Converged, but fitness {fitness} is high — likely a local minimum (try a smaller initial pose offset).",
    statusFail: "Stopped · only {pairs} pairs found within max correspondence distance.",
