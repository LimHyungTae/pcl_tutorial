...
| 13 | **GenZ-ICP** — adaptive ICP            | iteration별 α로 point-to-plane / point-to-point 가변 결합 |
| 14 | **KISS-Matcher** — global registration | FasterPFH + ROBIN + GNC, Python wrapper로 pre-compute      |
