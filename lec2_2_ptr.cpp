...
int main(int argc, char**argv) {
    ...
    *ptr_cloud = cloud2;
    ...
    // 91 번줄과는 다르게 *$Ptr$ = *$Ptr$을 하면 메모리에 있던 정보를 복사해서 넘겨준다는 의미임
    ...
    *ptr_cloud3 = *ptr_cloud;
    ...
    // 6: 1, 0, 0
    cout << " ------ $Ptr$ = $Ptr$ ------ " << endl;
    // ptr_cloud2는 91번째 줄에서 $Ptr$ = $Ptr$로 할당받았는데,
    ...
    cout << " ------ *$Ptr$ = *$Ptr$ ------ " << endl;
    // ptr_cloud3는 140번째 줄에서 *$Ptr$ = *$Ptr$로 할당받았는데,
